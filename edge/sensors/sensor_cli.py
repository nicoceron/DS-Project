#Recibir Argumentos desde consola -t tiempo -a ruta_archivo_configuracion -s tipo_sensor
import argparse
import threading
...
# python SensorImplementacion.py -s humo -t 3 -a ConfiguracionHumo.txt
# python SensorImplementacion.py -s temperatura -t 6 -a ConfiguracionTemperatura.txt
# python SensorImplementacion.py -s humedad -t 5 -a ConfiguracionHumedad.txt
